...
## A very exhaustive theme for Wordpress

This is the Supercellule framework theme we will use for all our wordpress projects. We start with FoundationPress adding to it many wonderful scripts : masonry, magnificpopup, slick, and many more. What follows is the original description. We will add soon related instructions for all things we included.
