...
<div class="row">
	...
	<?php while (have_posts()) : the_post(); ?>
		<article <?php post_class() ?> id="post-<?php the_ID(); ?>">
			<header class="CoverImage" style="background-image:url(<?php header_image(); ?>);">
				<h1 id="big" class="text-center lettres lightentry-title"><?php the_title(); ?></h1>
			</header>
	...
	<div class="small-12 large-12 columns" role="main">
		...
		<div class="row">
			...
			<div class="slider-basic">
  				<div><img src="http://lorempixel.com/320/320/nature/1" alt=""></div>
  				<div><img src="http://lorempixel.com/320/320/food/2" alt=""></div>
  				<div><img src="http://lorempixel.com/320/320/nature/3" alt=""></div>
  				<div><img src="http://lorempixel.com/320/320/food/4" alt=""></div>
  				<div><img src="http://lorempixel.com/320/320/nature/5" alt=""></div>
  				<div><img src="http://lorempixel.com/320/320/food/6" alt=""></div>
			</div>
			</div>

			<div class="medium-4 large-4 columns">
			<div class="slider-basic">
  				<div><img src="http://lorempixel.com/320/320/cats/1" alt=""></div>
  				<div><img src="http://lorempixel.com/320/320/cats/2" alt=""></div>
  				<div><img src="http://lorempixel.com/320/320/cats/3" alt=""></div>
  				<div><img src="http://lorempixel.com/320/320/cats/4" alt=""></div>
  				<div><img src="http://lorempixel.com/320/320/cats/5" alt=""></div>
  				<div><img src="http://lorempixel.com/320/320/cats/6" alt=""></div>
			</div>
			</div>

			<div class="medium-4 large-4 columns">
			<div class="slider-basic">
  				<div><img src="http://lorempixel.com/320/320/nightlife/1" alt=""></div>
  				<div><img src="http://lorempixel.com/320/320/nightlife/2" alt=""></div>
  				<div><img src="http://lorempixel.com/320/320/nightlife/3" alt=""></div>
  				<div><img src="http://lorempixel.com/320/320/nightlife/4" alt=""></div>
  				<div><img src="http://lorempixel.com/320/320/nightlife/5" alt=""></div>
  				<div><img src="http://lorempixel.com/320/320/nightlife/6" alt=""></div>
			</div>
			</div>
...
<div class="row">
	...
	<div id="msnry-gallery" class="js-masonry">
	<div class="item small-6 medium-4 large-3"><?php placeholdit_jpg_same_h(); ?></div>
	<div class="item small-6 medium-4 large-3"><?php placeholdit_jpg_same_h(); ?></div>
	<div class="item small-6 medium-4 large-3"><?php placeholdit_jpg_same_h(); ?></div>
	<div class="item small-6 medium-4 large-3"><?php placeholdit_jpg_same_h(); ?></div>
	<div class="item small-6 medium-4 large-3"><?php placeholdit_jpg_same_h(); ?></div>
...
<div class="wrapper">
	...
	<div class="large-12 columns">
	<div class="galerie">
		<a href="<?php placeholdit_jpg_src(); ?>"><img src="http://placehold.it/150.jpg" alt=""></a>
		<a href="<?php placeholdit_jpg_src(); ?>"><img src="http://placehold.it/150.jpg" alt=""></a>
		<a href="<?php placeholdit_jpg_src(); ?>"><img src="http://placehold.it/150.jpg" alt=""></a>
		<a href="<?php placeholdit_jpg_src(); ?>"><img src="http://placehold.it/150.jpg" alt=""></a>
		<a href="<?php placeholdit_jpg_src(); ?>"><img src="http://placehold.it/150.jpg" alt=""></a>
		...
		<a href="<?php placeholdit_jpg_src(); ?>"><img src="http://placehold.it/150.jpg" alt=""></a>
			...
			<div class="icon-bar five-up" role="navigation"> 
			  ...
			  <a class="item" role="button" tabindex="0" aria-label="Like"> 
			    <i class="fi-social-steam"></i> 
			    <label id="steam">Steam</label>
			  </a> 
			</div>
